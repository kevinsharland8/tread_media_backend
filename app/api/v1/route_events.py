...
async def event(
    ...
    query = "Select id, name, description, start_date, end_date, city, province_id, event_website, organizer, active, map_link, event_type_id, multi_day from events;"
...
async def single_event(
    ...
    query = """
    select id, name, description, start_date, end_date, city, province_id, event_website, organizer, active, map_link, event_type_id, multi_day from events where id = $1;
    """
